...
public final class InMemoryCompilerResult {
    ...
    InMemoryCompilerResult(
        ...
        this.generatedFiles = ImmutableList.copyOf(((InMemoryJavaFileManager) fileManager).getOutputFiles());
    }

    /**
     * The compiler.
     */
    public InMemoryCompiler compiler() {
        return compiler;
    }
    ...
    /**
     * All diagnostics reported during compilation. The order of the returned
     * list is unspecified.
     *
     * @see #errors()
     * @see #warnings()
     ...
     * Diagnostic.Kind#MANDATORY_WARNING mandatory warnings}) reported during
     * compilation.
     */
     ...
     * {@linkplain #status() failed compilations}, since the state of the
     * generated files is undefined in that case
     */
    ...
    /**
     * Returns the file with name {@code fileName} in package
     * {@code packageName} if one was generated.
     *
     * <p>
     * For example:
     *
    ...
    /**
     * Returns the source file for the type with a given qualified name (no
     * ".java" extension) if one was generated.
     *
     * <p>
     * For example:
     *
    ...
    public enum Status {
        ...
        SUCCESS,
        /**
         * GoogleCompilation finished with errors.
         */
        FAILURE,
    }
}
